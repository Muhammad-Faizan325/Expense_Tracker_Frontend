  ...
  return (
    <div className='flex max-h-screen bg-white overflow-hidden'>
      ...
      <div className='w-full lg:w-[55vw] px-6 sm:px-12 lg:px-20 flex flex-col'>
        ...
        <div className="max-w-[50vw] w-full mt-6 sm:mt-8">
          {children}
        </div>
      ...
      <div className="hidden lg:flex w-[45vw] bg-slate-50 relative flex-col justify-center items-center p-12 overflow-hidden">
        ...
        <div className='z-20 w-full max-w-sm mb-12'>
          <StatsInfocard
            ...
            value="$430,000"
            color="bg-gradient-to-tr from-emerald-600 to-emerald-800"
          />
        </div>
  ...
  return (
    <div className='flex items-center gap-5 bg-white p-5 rounded-3xl shadow-sm border border-gray-100 w-full'>
      ...
      <div>
        ...
        <span className='text-2xl font-black text-emerald-800 tracking-tight'>{value}</span>
      </div>
    </div>
  );
};
